...
public class Signature_Tech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signature_tech);
    ...
    public void saveImage(Bitmap myBitmap) {
        ...
        try {
            File f = new File(wallpaperDirectory, "signature_tech.jpg");
            f.createNewFile();
            FileOutputStream fo = new FileOutputStream(f);
            fo.write(bytes.toByteArray());
            MediaScannerConnection.scanFile(Signature_Tech.this,
